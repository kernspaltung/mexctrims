<div class="h_100">
  ...
  <div class="large-5 columns h_100 p0">
    ...
    <div id="informacion-faq-titulo" class="large-12 columns h_20">
      <!-- titulo -->
      <div class="large-12 fontXXL text-center black p0 vcenter">¿Qué es?</div>

    </div>

    <div id="informacion-que-es-lista-subtitulos" class="large-12 columns h_80">
  ...
  <div id="informacion-que-es-contenido" class="large-7 columns minH_100 p0">
    ...
    <h1 class="large-12 columns fontXL black text-cemter subheader bold p3">Titulo ¿Qué es?</h1>
    <div id="informacion-que-es-contenido-texto" class="medium-12 large-12 columns h_60 p4">
    ...
    <!-- <div id="informacion-que-es-contenido-texto-derecho" class="medium-12 large-6 columns h_60 p4">
