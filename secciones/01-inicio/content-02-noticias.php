<section id="noticias" class="row  mt_sm_0 mb0 mb_sm_1 p3 p_sm_2">

  <h3 class="small-12 small-text-center medium-text-left p0 mb1 secundario2_bg white p2 ">
    Noticias
  </h3>

  <section id="twitter" class="columns hide-for-small-only hide-for-medium-only medium-6 h_100vh white_bg mt1 scrollH">
  ...
  <section id="noticias" class="columns medium-12 large-6">
    ...
    if( $q -> have_posts() ) :
      while( $q -> have_posts() ) :
        ...
        <section id="noticia_destacada" class="columns h_sm_90vh h_md_60vh h_lg_70vh m0 mb2 p0">
          <a href="<?php echo get_the_permalink(get_the_ID()); ?>" class="h_100 tarjeta  white_bg p4 ">
            ...
            <div class="extracto_fecha small-12 medium-6 columns p0 pl2 pl_sm_0 text-left h_80 h_sm_35">
              <div class="columns p0 pt_sm_3 pt0 pb0 font_sm_M font_md_M font_lg_M">
                <?php echo apply_filters( 'the_excerpt', wp_trim_words( get_the_excerpt(), 16 ) ); ?>
              </div>
    ...
    <section id="inicio-noticias-medium" class="columns p0 pt0 m0 text-center rel hide-for-small-only">
      ...
      if( $q -> have_posts() ) :
        while( $q -> have_posts() ) :
          ...
          <article class="noticia_destacada_secundaria_inicio small-12 medium-6 columns h_50vh p2 pt0">
...
<div class="columns h_10 text-right p2 pr1 m0">
  ...
  <a class="h_100 w_100" href="<?php echo get_the_permalink( get_page_by_title("Noticias")->ID ); ?>">
