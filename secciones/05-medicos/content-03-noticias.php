   ...
   if ($q -> have_posts() ) :
      while ($q -> have_posts() ) :
         ...
         ?>
            ...
            <article id="medicos-portada-entrada-<?php echo get_the_ID(); ?>" class="entrada_medicos columns h_80vh medium-6 large-4 p3">
               <!-- (.small-5.columns.h_100>.h_100.imgLiquid.imgLiquidFill>img[src="http://fakeimg.pl/600x300"])+.small-7.columns.h_100{lorem10} -->
                  ...
                  <div class="columns p2 fontXS text-left">
                     ...
                     <div class="medium-8 large-7 columns p0">
                        ...
                        <div class="comentarios-boton columns h_30vh p0 mb2 ">
                        <div id="medicos-portada-entrada-destacada-comentarios" class="columns h_50 p0">
                           <div class="small-7 medium-8 large-9 columns h_100 p0">
                              ...
                              <div class="columns h_30 primario_acento_bd p0">
                                 <div class="h_5vh fontM black p0">
                                    <div class="columns w_a vcenter "><i class="fa fa-comments-o fontL"></i></div>
                           ...
                           <button class="small-5 medium-4 large-3 columns button h_100 pointer  m0 primario_acento_bd p2">
