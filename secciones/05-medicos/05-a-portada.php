<div id="portada_medicos" class="h_100">
  <div class="medium-12 large-12 columns h_20 p0">
    ...
    <div id="medicos-portada-titulo-imagen" class="large-5 columns h_100 p0">
    ...
    <div id="medicos-portada-extracto-entrada" class="large-7 columns h_100 p0">
  ...
  <div class="large-12 columns h_60 p0">
    ...
    <div  class="large-7 columns h_100 p0">
      ...
      <article id="medicos-portada-entrada" class="entrada_medicos entrada large-12 columns h_40 pr0">
        <a href="">
            ...
            <div class="large-6 columns h_100 p0">
              <div class="large-8 columns h_100">
                <div class="large-12 columns h_60">
                  <div class="large-12 fontM black vcenter">Dr. Nombre del Doctor </div>
                </div>
                <div class="large-12 columns h_40">
                  <div class="large-12 fontXS subheader vcenter">Publicado el 1 de enero, 2016 </div>
                </div>
              </div>
              <div class="large-4 columns h_100 p0">
                <div class="h_100 imgLiquid imgLiquidFill"><img src="http://fakeimg.pl/100x100" alt=""></div>
              </div>
            </div>
          </div>
        </a>
  ...
  <div class="large-12 columns minH_20">
    <!-- .row.large-4.h_20vh>(.large-12.columns.h_30>.large-12.fontM.bold.black.vcenter{Titulo Entrada})+.large-12.columns.h_70>((.large-9.columns.h_100>(.large-12.columns.h_50>.large-12.fontS.bold.vcenter{Autor})+.large-12.columns.h_50>.large-12.fontS.bold.vcenter{YYYY/MM/DD})+.large-3.columns.h_100>.button.hollow.h_100.w_100>i.fa.fa-angle-right) -->
    <?php
    $html = "";
    for ($i=0; $i < 3; $i++) {
      $html .= '

      <div class="large-4 column h_100 vcenter">
        <div class="large-12 columns h_40">
          <div class="large-12 fontM bold black vcenter">Titulo Entrada</div>
        </div>
        <div class="large-12 columns h_60">
          <div class="large-9 columns h_100">
            <div class="large-12 columns h_50">
              <div class="large-12 text-left fontS bold vcenter">Autor</div>
            </div>
            <div class="large-12 columns h_50">
              <div class="large-12 text-left fontS bold vcenter">YYYY/MM/DD</div>
            </div>
          </div>
          <div class="large-3 columns h_100">
            <div class="button hollow h_100 w_100">
